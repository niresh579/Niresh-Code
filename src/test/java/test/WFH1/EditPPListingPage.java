...
public class EditPPListingPage extends BaseTest{
...
mobileEmulation);
    ...
    public void testUntitled() throws Throwable {
    	...
    	EditPPListingPagePOM rp= new EditPPListingPagePOM(driver);
            Thread.sleep(5000);
...
//
             ...
             }else if (BaseTest.getExcelData("pp", 1, 8).contains("PhysicallyChallenged")) {
                     WebElement marital2=driver.findElement(By.xpath("//*[@id='chkbox1']"));
                     if (marital2.isSelected()) {
                             System.out.println("älready selected");
                     }
             ...
             }else if (BaseTest.getExcelData("pp", 1, 10).contains("Light / Socialdrinker")) {
                     WebElement marital0=driver.findElement(By.xpath("//*[@id='chkbox2']"));
                     if (marital0.isSelected()) {
                             System.out.println("älready selected");
                     }
             ...
             }else if (BaseTest.getExcelData("pp", 1, 11).contains("Light / Socialsmoker")) {
                     WebElement marital0=driver.findElement(By.xpath("//*[@id='chkbox2']"));
                     if (marital0.isSelected()) {
                             System.out.println("älready selected");
                     }
             ...
             Thread.sleep(3000);
                JavascriptExecutor js = (JavascriptExecutor)driver;
                  WebElement edit=
driver.findElement(By.xpath("//*[@id='edit-prof_footer']/div[2]"));
     ...
     BaseTest.click(rp.getProfessionalinformation());
             ...
             BaseTest.click(rp.getAnnualincomefrom());
              ...
              BaseTest.click(rp.getAnnualincometo());
               ...
               Thread.sleep(4000);
               driver.findElement(By.xpath("(//*[@id='Popupclose'])[2]")).click();
